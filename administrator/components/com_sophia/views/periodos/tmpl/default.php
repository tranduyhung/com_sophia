		...
		<table class="adminlist">
			<thead>
				<tr>
					...
					<th width="20%" class="title"><?php echo JHTML::_('grid.sort',   'nombre', 'nombre', @$this->lists['order_Dir'], @$this->lists['order'] ); ?>
					</th>

					<th width="10%" class="title"><?php echo JHTML::_('grid.sort',   'periodo', 'periodo', @$this->lists['order_Dir'], @$this->lists['order'] ); ?>
					</th>

					<th width="20%" class="title"><?php echo JHTML::_('grid.sort',   'inicio', 'inicio', @$this->lists['order_Dir'], @$this->lists['order'] ); ?>
					</th>

					<th width="20%" class="title"><?php echo JHTML::_('grid.sort',   'termino', 'termino', @$this->lists['order_Dir'], @$this->lists['order'] ); ?>
					</th>

					<th width="10%" class="title"><?php echo JHTML::_('grid.sort',   'anno', 'anno', @$this->lists['order_Dir'], @$this->lists['order'] ); ?>
					</th>

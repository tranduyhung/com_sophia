...
<form action="index.php" method="post" name="adminForm" id="adminForm">
	<fieldset class="adminform">
		<table class="admintable">
			<tbody>
				<tr>
					<td width="20%" class="key"><label for="name"> <?php echo JText::_( 'Matricula' ); ?>:
					</label>
					</td>
					<td width="80%"><input class="inputbox" type="text"
						name="nromatricula" id="nromatricula" size="30"
						value="<?php echo $this->matricula->nromatricula;?>" />
					</td>
				</tr>
				<tr>
				...
				<tr>
					<td width="20%" class="key"><label> <?php echo JText::_( 'A�o' ); ?>:
					</label>
					</td>
	...
	<input type="hidden" name="cid[]"
		value="<?php echo $this->matricula->id; ?>" /> <input type="hidden"
		name="option" value="com_sophia" /> <input type="hidden" name="task"
		value="" /> <input type="hidden" name="controller" value="matricula" />
</form>

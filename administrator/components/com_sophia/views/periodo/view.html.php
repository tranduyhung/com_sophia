...
class SophiaViewPeriodo extends JView
{
	function display($tpl = null)
	{
		...
		JToolBarHelper::title(   '&nbsp;&nbsp;' .JText::_( 'Periodo' ).': <small><small>[ ' . $text.' ]</small></small>', 'periodos');

		JToolBarHelper::save('save');
		JToolBarHelper::cancel();

		$lists['periodo'] = nomHelperLoad::getlist_Per($periodo->periodo);
		$lists['anno'] = nomHelperLoad::getlist_Anno($periodo->anno_id);

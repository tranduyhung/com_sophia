...
<form action="index.php" method="post" name="adminForm">
		...
		<table class="adminlist">
			<thead>
				<tr>
					...
					<th width="30%" class="title"><?php echo JHTML::_('grid.sort',   'Anotacion', 'Anotacion', @$this->lists['order_Dir'], @$this->lists['order'] ); ?>
					</th>
			...
			for ($i=0, $n=count( $this->anotaciones ); $i < $n; $i++)
			{
				...
				$link 		= JRoute::_( 'index.php?option=com_sophia&controller=anotacion&task=edit&cid[]='. $row->id);
				...
				<tr class="<?php echo "row$k"; ?>">
					...
					<td align="center"><span class="editlinktip hasTip"
						title="<?php echo JText::_( 'Edit Item' );?>::<?php echo JText::_( 'Edit Item DESC' );?>">
							<a href="<?php echo $link  ?>"> <?php echo $row->anotacion; ?> </a>
					</span>
					</td>
	...
	<input type="hidden" name="option" value="com_sophia" /> <input
		...
		type="hidden" name="controller" value="anotacion" /> <input
		type="hidden" name="view" value="anotaciones" />

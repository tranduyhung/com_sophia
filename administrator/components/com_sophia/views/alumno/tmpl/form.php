...
<form action="index.php" method="post" name="adminForm" id="adminForm">
			...
			<tbody>
				...
				<tr>
					...
					if ($ver->RELEASE >= '1.6') {
						...
						echo JHtml::_('calendar',  $this->alumno->nacimiento, 'nacimiento', 'nacimiento', "%Y-%m-%d", '');
	...
	<input type="hidden" name="cid[]"
		value="<?php echo $this->alumno->id; ?>" /> <input type="hidden"
		name="option" value="com_sophia" /> <input type="hidden" name="task"
		value="" /> <input type="hidden" name="controller" value="alumno" />
</form>

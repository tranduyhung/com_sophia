...
class SophiaModelinasistencias extends JModel
{
	var $_data;
	...
	function _buildQuery()
	{
		...
		$where[] = ' anot.matricula_id = mat.id';
		...
		$this->_query = ' SELECT anot.* ,cur.curso AS curso , est.nombre AS alumno , anno.anno As anno '
		. ' FROM #__sophia_matricula AS mat'
		.',#__sophia_curso AS cur'
		.', #__sophia_estudiantes AS est '
		.', #__sophia_anno AS anno '
		.', #__sophia_inasistencias AS anot '
		. $where
		. $orderby
		;

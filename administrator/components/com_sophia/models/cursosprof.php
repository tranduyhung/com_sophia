...
class SophiaModelCursosprof extends JModel
{
	var $_data;
	...
	function _buildQuery()
	{
		...
		$orderby = '';
		if (($this->filter_order != 'curso') && ($this->filter_order != 'profesor') && ($this->filter_order != 'published') && ($this->filter_order != 'id')) $this->filter_order = '';
		if (($this->filter_order) && ($this->filter_order_Dir))
		$orderby 	= ' ORDER BY '. $this->filter_order .' '. $this->filter_order_Dir;

		$this->_query = ' SELECT al.id , al.published ,cur.curso AS curso , prof.nombre AS profesor '
		. ' FROM #__sophia_curso_prof AS al,#__sophia_curso AS cur, #__sophia_profesores AS prof '
		. $where
		. $orderby
		;

...
class SophiaControllerComuna extends SophiaController
{
	...
	{
		$this->_query = 'UPDATE #__sophia_comuna'
	...
	function cancel()
	{
		...
		$this->setRedirect( 'index.php?option=com_sophia&view=comunas', $msg );
	}
	function publish()
	{
		...
		$link = 'index.php?option=com_sophia&view=comunas';

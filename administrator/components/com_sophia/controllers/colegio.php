...
class SophiaControllerColegio extends SophiaController
{
	...
	{
		$this->_query = 'UPDATE #__sophia_colegio'
	...
	function cancel()
	{
		...
		$this->setRedirect( 'index.php?option=com_sophia&view=sophia', $msg );
	}
	function publish()
	{
		...
		$link = 'index.php?option=com_sophia&view=sophia';

...
class SophiaControllerEvaluacion extends SophiaController
{
	...
	function edit()
	{
		JRequest::setVar( 'view', 'evaluacion' );
	...
	function cancel()
	{
		...
		$this->setRedirect( 'index.php?option=com_sophia&view=evaluaciones', $msg );
	}
	function publish()
	{
	...
	function save()
	{
		...
		$model = $this->getModel( 'evaluacion' );
		if ($model->store($post)) {

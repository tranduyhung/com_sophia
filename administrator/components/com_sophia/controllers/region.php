...
class SophiaControllerRegion extends SophiaController
{
	...
	{
		$this->_query = 'UPDATE #__sophia_region'
	...
	function cancel()
	{
		...
		$this->setRedirect( 'index.php?option=com_sophia&view=regiones', $msg );
	}
	function publish()
	{
		...
		$link = 'index.php?option=com_sophia&view=regiones';

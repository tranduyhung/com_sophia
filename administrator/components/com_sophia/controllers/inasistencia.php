...
class SophiaControllerInasistencia extends SophiaController
{
	...
	{
		$this->_query = 'UPDATE #__sophia_inasistencias'
	...
	function edit()
	{
		JRequest::setVar( 'view', 'inasistencia' );
	...
	function cancel()
	{
		...
		$this->setRedirect( 'index.php?option=com_sophia&view=inasistencias', $msg );
	}
	function publish()
	{
		...
		$link = 'index.php?option=com_sophia&view=inasistencias';
	...
	function save()
	{
		...
		$model = $this->getModel( 'inasistencia' );
		if ($model->store($post)) {

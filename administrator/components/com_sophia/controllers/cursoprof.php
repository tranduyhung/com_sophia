...
class SophiaControllercursoprof extends SophiaController
{
	...
	{
		$this->_query = 'UPDATE #__sophia_curso_prof'
	...
	function edit()
	{
		JRequest::setVar( 'view', 'cursoprof' );
	...
	function cancel()
	{
		...
		$this->setRedirect( 'index.php?option=com_sophia&view=cursosprof', $msg );
	}
	function publish()
	{
		...
		$link = 'index.php?option=com_sophia&view=cursosprof';

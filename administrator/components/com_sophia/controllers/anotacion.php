...
class SophiaControllerAnotacion extends SophiaController
{
	...
	{
		$this->_query = 'UPDATE #__sophia_anotaciones'
	...
	function edit()
	{
		JRequest::setVar( 'view', 'anotacion' );
	...
	function cancel()
	{
		...
		$this->setRedirect( 'index.php?option=com_sophia&view=anotaciones', $msg );
	}
	function publish()
	{
		...
		$link = 'index.php?option=com_sophia&view=anotaciones';

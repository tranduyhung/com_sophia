...
class SophiaControllerCiudad extends SophiaController
{
	...
	{
		$this->_query = 'UPDATE #__sophia_ciudad'
	...
	function cancel()
	{
		...
		$this->setRedirect( 'index.php?option=com_sophia&view=ciudades', $msg );
	}
	function publish()
	{
		...
		$link = 'index.php?option=com_sophia&view=ciudades';

...
class SophiaControllerasignatura extends SophiaController
{
	...
	{
		$this->_query = 'UPDATE #__sophia_asignaturas'
	...
	function edit()
	{
		JRequest::setVar( 'view', 'asignatura' );
	...
	function cancel()
	{
		...
		$this->setRedirect( 'index.php?option=com_sophia&view=asignaturas', $msg );
	}
	function publish()
	{
	...
	function save()
	{
		...
		$model = $this->getModel( 'asignatura' );
		if ($model->store($post)) {

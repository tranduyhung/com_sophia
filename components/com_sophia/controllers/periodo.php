...
class SophiaControllerperiodo extends SophiaController
{
	...
	{
		$this->_query = 'UPDATE #__sophia_periodo'
	...
	function cancel()
	{
		...
		$this->setRedirect( 'index.php?option=com_sophia&view=periodos', $msg );
	}
	function publish()
	{
		...
		$link = 'index.php?option=com_sophia&view=periodos';

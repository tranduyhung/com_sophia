...
class SophiaControllerMatricula extends SophiaController
{
	...
	{
		$this->_query = 'UPDATE #__sophia_matricula'
	...
	function edit()
	{
		JRequest::setVar( 'view', 'matricula' );
	...
	function cancel()
	{
		...
		$this->setRedirect( 'index.php?option=com_sophia&view=matriculas', $msg );
	}
	function publish()
	{
		...
		$link = 'index.php?option=com_sophia&view=matriculas';

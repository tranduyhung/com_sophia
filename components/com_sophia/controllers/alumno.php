...
class SophiaControlleralumno extends SophiaController
{
	...
	{
		$this->_query = 'UPDATE #__sophia_estudiantes'
	...
	function cancel()
	{
		...
		$this->setRedirect( JRoute::_('index.php?option=com_sophia&view=alumnos'), $msg );
	}
	function publish()
	{
	...
	function remove()
	{
		...
		$this->setRedirect( 'index.php?option=com_sophia&view=alumnos', $msg );
	}
}

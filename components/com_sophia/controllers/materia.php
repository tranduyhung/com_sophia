...
class SophiaControllerMateria extends SophiaController
{
	...
	{
		$this->_query = 'UPDATE #__sophia_materias'
	...
	function cancel()
	{
		...
		$this->setRedirect( 'index.php?option=com_sophia&view=materias', $msg );
	}
	function publish()
	{
		...
		$link = 'index.php?option=com_sophia&view=materias';

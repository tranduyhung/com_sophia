...
class SophiaModelprofesores extends JModel
{
	var $_data;
	...
	function _buildQuery()
	{
		...
		$orderby = '';
		if (($this->filter_order != 'nombre') && ($this->filter_order != 'rut') && ($this->filter_order != 'email') && ($this->filter_order != 'published') && ($this->filter_order != 'id')) $this->filter_order = '';
		if (($this->filter_order) && ($this->filter_order_Dir))
		$orderby 	= ' ORDER BY '. $this->filter_order .' '. $this->filter_order_Dir;

		$this->_query = ' SELECT al.*'
		. ' FROM #__sophia_profesores AS al'
		. $where
		. $orderby
		;
		return $this->_query;

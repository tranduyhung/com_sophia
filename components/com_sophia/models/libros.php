...
class SophiaModelLibros extends JModel
{
	var $_data;
	...
	function _buildQuery()
	{
		...
		if ($this->search)
		{
			$where[] = 'LOWER(titulo) LIKE \'%'. $this->search. '%\'';
		}

		$where 		= ( count( $where ) ? ' WHERE ' . implode( ' AND ', $where ) : '' );

		$orderby = '';
		if (($this->filter_order != 'titulo') && ($this->filter_order != 'autor') && ($this->filter_order != 'editorial') && ($this->filter_order != 'ciudad') ) $this->filter_order = '';

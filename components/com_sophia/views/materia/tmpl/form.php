...
<table class="admintable">
	<form action="index.php" method="post" name="adminForm" id="adminForm">
				...
				<tbody>
					...
					<table class="admintable">
						<tr>
							...
							echo $this->editor->display( 'descripcion',  $this->materias->descripcion, '550', '300', '60', '20', false ) ;
							?>
							</td>
						</tr>
					</table>
		...
		<input type="submit" name="save"
			...
			name="cid[]" value="<?php echo $this->materia->id; ?>" /> <input
			type="hidden" name="option" value="com_sophia" /> <input
			type="hidden" name="task" value="save" /> <input type="hidden"
			name="controller" value="materia" />
	</form>
</table>

...
echo SophiaHelperToolbar::IconButtonEdit( 'curso', 'icons/nuevo.png', JText::_( 'Nuevo' ),JText::_( 'Nuevo' ),JText::_( 'descripcion Nuevo Alumno' ) );
...
<form action="index.php" method="post" name="adminForm">
	...
	<div id="tablecell">
		<table class="adminlist">
			...
			for ($i=0, $n=count( $this->cursos ); $i < $n; $i++)
			{
				...
				$link 		= JRoute::_( 'index.php?option=com_sophia&controller=curso&task=edit&cid[]='. $row->id);
				$linkpublicar		= JRoute::_( 'index.php?option=com_sophia&controller=curso&task=publish&cid[]='. $row->id);
				$linkdespublicar	= JRoute::_( 'index.php?option=com_sophia&controller=curso&task=unpublish&cid[]='. $row->id);
	...
	<input type="hidden" name="option" value="com_sophia" /> <input
		...
		type="hidden" name="controller" value="curso" /> <input type="hidden"
		name="view" value="cursos" />

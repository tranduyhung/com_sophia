...
echo SophiaHelperToolbar::IconButtonEdit( 'profesor', 'icons/nuevo.png', JText::_( 'Nuevo' ),JText::_( 'Nuevo' ),JText::_( 'descripcion Nuevo Alumno' ) );
...
<form action="index.php" method="post" name="adminForm">
	...
	<div id="tablecell">
		<table class="adminlist">
			...
			<?php
			$k = 0;
			for ($i=0, $n=count( $this->profesores ); $i < $n; $i++)
			{
				$row = &$this->profesores[$i];

				$link 		= JRoute::_( 'index.php?option=com_sophia&controller=profesor&task=edit&cid[]='. $row->id);
				...
				<tr class="<?php echo "row$k"; ?>">
					...
					<td align="center"><?php if ($row->published==0) { ?> <a
						href="<?php echo $linkpublicar; ?>"> <img
	...
	<input type="hidden" name="option" value="com_sophia" /> <input
		...
		type="hidden" name="controller" value="profesor" /> <input
		type="hidden" name="view" value="profesores" />

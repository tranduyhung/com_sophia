...
echo SophiaHelperToolbar::IconButtonEdit( 'asignatura', 'icons/nuevo.png', JText::_( 'Nuevo' ),JText::_( 'Nuevo' ),JText::_( 'descripcion Nuevo Alumno' ) );
...
<form action="index.php" method="post" name="adminForm">
		...
		<table class="adminlist">
			<thead>
				<tr>
					...
					<th width="30%" class="title"><?php echo JHTML::_('grid.sort',   'asignaturas', 'asignaturas', @$this->lists['order_Dir'], @$this->lists['order'] ); ?>
					</th>
			...
			for ($i=0, $n=count( $this->asignaturas ); $i < $n; $i++)
			{
				...
				$link 		= JRoute::_( 'index.php?option=com_sophia&controller=asignatura&task=edit&cid[]='. $row->id);
				$linkpublicar		= JRoute::_( 'index.php?option=com_sophia&controller=profesor&task=publish&cid[]='. $row->id);
				$linkdespublicar	= JRoute::_( 'index.php?option=com_sophia&controller=profesor&task=unpublish&cid[]='. $row->id);
				...
				<tr class="<?php echo "row$k"; ?>">
					...
					<td><span class="editlinktip hasTip"
						title="<?php echo JText::_( 'Edit Item' );?>::<?php echo JText::_( 'Edit Item DESC' );?>">
							<a href="<?php echo $link  ?>"> <?php echo $row->asignatura; ?> </a>
					</span>
					</td>
	...
	<input type="hidden" name="option" value="com_sophia" /> <input
		...
		type="hidden" name="controller" value="asignatura" /> <input
		type="hidden" name="view" value="asignaturas" />

...
echo SophiaHelperToolbar::IconButtonEdit( 'evaluacion', 'icons/nuevo.png', JText::_( 'Nuevo' ),JText::_( 'Nuevo' ),JText::_( 'descripcion Nuevo Alumno' ) );
...
<form action="index.php" method="post" name="adminForm">
	...
	<div id="tablecell">
		<table class="adminlist">
			...
			for ($i=0, $n=count( $this->evaluaciones ); $i < $n; $i++)
			{
				...
				$link 		= JRoute::_( 'index.php?option=com_sophia&controller=evaluacion&task=edit&cid[]='. $row->id);
				$linkpublicar		= JRoute::_( 'index.php?option=com_sophia&controller=evaluacion&task=publish&cid[]='. $row->id);
				$linkdespublicar	= JRoute::_( 'index.php?option=com_sophia&controller=evaluacion&task=unpublish&cid[]='. $row->id);
	...
	<input type="hidden" name="option" value="com_sophia" /> <input
		...
		type="hidden" name="controller" value="evaluacion" /> <input
		type="hidden" name="view" value="evaluaciones" />
